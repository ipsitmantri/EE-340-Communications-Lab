...
class lab1_task4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 1 Task 4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 1 Task 4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_task4")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_KAISER,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/ipsit/Documents/EE 340/Lab 1/shor.wav', True)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/ipsit/Documents/EE 340/Lab 1/denoised.wav', 1, samp_rate, 8)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 100, 7000, 50, firdes.WIN_KAISER, 6.76))
        self.blocks_throttle_0.set_sample_rate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 2100, 100, firdes.WIN_KAISER, 6.76))
...
def main(top_block_cls=lab1_task4, options=None):
