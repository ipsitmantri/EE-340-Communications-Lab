...
class my_first(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "my first flowgraph")
        ...
        self.settings = Qt.QSettings("GNU Radio", "my_first")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((262,262,293,261,349,329,261,261,293,261,392,349,261,261,277,440,392,349,329,466,466,440,349,392,349), True, 1, [])
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, 32, 2)
...
def main(top_block_cls=my_first, options=None):
