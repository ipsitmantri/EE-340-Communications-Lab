...
# Title: Lab 2 Task 3
# Author: ipsit
# Description: Frequency Modulator
...
class lab2_task3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 2 Task 3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 2 Task 3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_task3")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Frequency Modulated Signal', #name
            1 #number of inputs
        )
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20000, 4, 0, 0)
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(62831.85307)
...
def main(top_block_cls=lab2_task3, options=None):
