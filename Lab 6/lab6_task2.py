...
class lab6_task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.iir_filter_xxx_0, 0), (self.digital_cma_equalizer_cc_0, 0))
...
def main(top_block_cls=lab6_task2, options=None):
